define( [
     ...
     */
        ...
        _getReservedMatrix: function () {
            ...
            var m = Node.__reserveMatrixStack[ Node._reserveMatrixStack.current++ ];

            if ( Node._reserveMatrixStack.current === Node._reserveMatrixStack.length ) {
        ...
        _resetReservedMatrix: function () {
            ...
            Node.__reserveMatrixStack.current = 0;
